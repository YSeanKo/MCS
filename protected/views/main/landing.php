    ...
    <div class="row">
        <div class="col-md-6  col-md-offset-3">
            <form class="form-signin" _lpchecked="1">
                ...
                <a class="btn btn-lg btn-primary btn-block" href="<?= $this->createUrl('/main/home')?>">Login</a>
